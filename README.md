...
3.bonus
	...
	我們額外加了一個"UNCLEAR"的button，當你不小心按到"CLEAR"時，可以回復本來在上面的角色。
	方法為多設一個prevCharactersOnCircle的ArrayList，紀錄按下前在圓上的點。
	但只能針對剛按完"CLEAR"之後的回復，後續如果其他動作只會回復到按下"CLEAR"之前的狀態。
